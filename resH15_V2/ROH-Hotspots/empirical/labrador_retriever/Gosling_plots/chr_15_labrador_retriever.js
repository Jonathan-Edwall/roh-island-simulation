const current_chromosome = "Chromosome 15"
// const url_roh_segments_file = "http://127.0.0.1:5500/autosome_roh_freq/labrador_retriever_CHR1_ROH_freq_threshold_0.554054"
const url_roh_segments_file = "http://127.0.0.1:5500/autosome_roh_freq/labrador_retriever_CHR15_ROH_freq_threshold_0.554054.tsv"
const url_ROH_hotspots = "http://127.0.0.1:5500/roh_hotspots_freq/labrador_retriever_CHR15_ROH_Hotspot_freq.tsv"
const plot_title = current_chromosome +" - ROH-Hotspot 55 % Cutoff"
...
const value_ROH_threshold = 0.554054 // y_column = "Frequency"
...
,
        {
            ...
            "tooltip": [
...

                {
                    ...
                    "type": "quantitative",
                    "format": "0.2f",
                    "alt": "ROH-Hotspot: Hotspot length (Mb)"
                },
