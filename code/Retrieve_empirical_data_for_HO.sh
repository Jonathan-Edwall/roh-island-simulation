...
preprocessed_empirical_breed_data_dir="${preprocessed_data_dir}/empirical/${empirical_dog_breed}"
...
Empirical_breed_expected_heterozygosity_dir_NO_MAF=$expected_heterozygosity_dir_NO_MAF/empirical/$empirical_dog_breed
Empirical_breed_expected_heterozygosity_dir_MAF_0_05=$expected_heterozygosity_dir_MAF_0_05/empirical/$empirical_dog_breed
Empirical_breed_expected_heterozygosity_dir_MAF_0_01=$expected_heterozygosity_dir_MAF_0_01/empirical/$empirical_dog_breed
##############################################################################################  
