...
input_variant_freq_data <- file.path(variant_freq_plots_dir,"sim_5_selection_model_s08_chr3.txt")
...
length_window_MB
  ...
  write.table(variant_window_table_sorted, file = filename, quote = FALSE, col.names = FALSE, row.names = FALSE)
