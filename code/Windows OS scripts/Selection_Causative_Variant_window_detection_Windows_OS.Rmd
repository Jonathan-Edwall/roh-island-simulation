...
simulated_data_name <- "simulated_test"
# raw_simulated_data_dir <- file.path(repository_path,"data/raw/simulated_test")
raw_selection_data_dir <- file.path(repository_path,"data/raw",simulated_data_name,"selection_model")
...
chr_number <- as.numeric(sub(tolower("chr"), "", tolower(chr_simulated)))

#################################### 
# Defining the output 
#################################### 
output_dir <- file.path(results_dir,"causative_variant_windows")
