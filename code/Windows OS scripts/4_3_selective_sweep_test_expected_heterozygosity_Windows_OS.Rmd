...
ROH_hotspots_dir <- file.path(results_dir,"ROH-Hotspots/empirical/labrador_retriever")
...
empirical_genomewide_allele_freq_dir <- file.path(results_dir,"PLINK/allele_freq/empirical/labrador_retriever")
# simulated_model_allele_freq_dir <- file.path(results_dir,"PLINK/allele_freq/simulated/neutral_model")
simulated_model_allele_freq_dir <- file.path(results_dir,"PLINK/allele_freq/simulated/selection_model")
# sim_scenario_id <- "neutral_model_chr3"
# sim_scenario_id <- "selection_model_s01_chr3"
sim_scenario_id <- "selection_model_s08_chr3"
...
output_dir_sweep_test <- file.path(results_dir,"Sweep_test/labrador_retriever")
...
output_empirical_H_e_dir <- file.path(expected_heterozygosity_results_dir,"empirical/labrador_retriever")
...
output_simulated_model_H_e_dir <- file.path(expected_heterozygosity_results_dir,"simulated/selection_model")
