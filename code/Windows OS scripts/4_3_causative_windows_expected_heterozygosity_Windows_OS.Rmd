...
Windows_after_MAF_pruning <- nrow(causative_variant_window_tables_Selection_Model[[sim_scenario_to_follow]][[sim_id_to_follow]][["causative_window_data"]]["H_e"])
cat("100kbp Windows in the causative window after pruning, for simulation ",sim_id_to_follow,"of the ",sim_scenario_to_follow,": ",Windows_after_MAF_pruning,"\n")

Windows_with_he_01_or_less <- length(causative_variant_window_tables_Selection_Model[[sim_scenario_to_follow]][[sim_id_to_follow]][["causative_window_data"]]["H_e"][causative_variant_window_tables_Selection_Model[[sim_scenario_to_follow]][[sim_id_to_follow]][["causative_window_data"]]["H_e"] < 0.1])
cat("% 100kbp Windows with H_e <= 0.1:\n", round((Windows_with_he_01_or_less/Windows_after_MAF_pruning)*100 , 1), "\n")

fixated_Windows <- length(causative_variant_window_tables_Selection_Model[[sim_scenario_to_follow]][[sim_id_to_follow]][["causative_window_data"]]["H_e"][causative_variant_window_tables_Selection_Model[[sim_scenario_to_follow]][[sim_id_to_follow]][["causative_window_data"]]["H_e"] == 0])

cat("% fixated 100kbp Windows with H_e = 0:\n", round((fixated_Windows/Windows_after_MAF_pruning)*100 , 1), "\n")
```
...
for (selection_scenario in names(causative_variant_window_tables_Selection_Model)) {
  ...
  filename <- file.path(output_causative_variant_H_e_dir, paste(selection_scenario,"_avg_H_e_",".tsv", sep = ""))
