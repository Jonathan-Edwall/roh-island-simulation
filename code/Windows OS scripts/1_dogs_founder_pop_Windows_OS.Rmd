---
title: "Founder population simulation for Dogs in AlphaSimR"
output:
  html_document:
    toc: true
    toc_depth: 3  
...
output_dir_simulation <- file.path(YOUR_GITHUB_ROOT_DIRECTORY, repository_path,"")
...
chr_simulated <- "chr28"
snp_density_Mb = 96.64

# Define the base name for the output .map & .ped PLINK files
output_sim_files_basename <- paste0("post_bottleneck_population_", chr_simulated)
...
founderGenomes <- runMacs2(nInd = 2500,
                     nChr = 1,
                     Ne = 2500,
...
writePlink(last_bottleneck_generation,simParam=SP, baseName=output_sim_files_basename,
