---
title: "ROH-hotspot identification - Neutral Model"
output:
  html_document:
    toc: true
    toc_depth: 3  
...
#0: Setting up the Working,input and output-Directory  of the .rmd script
...
#################################### 
#input_file = "./results/Bedtools/coverage/simulated/neutral_model/autosomes_100kb_window_size/results/sorted_pop_coverage.bed"

input_file_dir <- file.path(YOUR_GITHUB_ROOT_DIRECTORY, repository_path,"results/Bedtools/coverage/simulated/neutral_model/autosomes_100kb_window_size/results")

input_file <- file.path(input_file_dir,"sorted_population_coverage.bed")
...
output_dir <- "./results/ROH-Hotspots/simulated/neutral_model/"
...
## 1.2: Merging together adjacent ROH-hotspot windows
