...
s <- 0.05 # Selection coefficient - 0.05 default
...
n_generations_mate_selection <- 40 # 40
...
### 2.4.2 Simulating the selection scenario - makeCross()
```{r}
...
# print(last_mate_selection_generation)

# Open a PNG graphics device with the desired filename
#png(paste0(output_sim_files_basename, '.png'))

# Set the plot title
plot_title <- sprintf("Causative-Variant Allele frequency plot - s=%g (%d replicates pruned) ", s, disappearance_counter)
