...
# export data_dir="$HOME/data_HO_refined"
# export results_dir="$HOME/results_HO_refined"
...
runtime_log="$script_dir/Hyperoptimization_pipeline_runtime_top_n_results.txt"
