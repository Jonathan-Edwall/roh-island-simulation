...
## Define the output directory based on the parameter passed from the Bash script
...
output_dir_simulation <- Sys.getenv("output_dir_simulation")
...
# Define the chromosome to be simulated (already defined outside)
...
#### 1.2.1.0 Single chromosome usage: Compute number of SNPs to use
...
#### 1.2.1.1: \$addSnpChip() - Randomly assigns eligible SNPs to a SNP chip
...
### 1.2.2: \$setTrackRec() - Setting on recombination tracking for the simulation
