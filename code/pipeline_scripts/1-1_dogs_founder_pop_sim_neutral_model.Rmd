...
```{r}
random_mating_bottleneck <- function(pop, SP, n_gen) {
...
random_mating_breed_formation <- function(pop, SP, n_gen,n_indv_breed_formation) {
...
breed1_bottleneck <- random_mating_bottleneck(breed1_founders, SP, n_generations_bottleneck)
...
```{r}
random_mating_generations <- random_mating_breed_formation(last_bottleneck_generation, SP, n_generations_random_mating,n_indv_breed_formation)
