...
n_generations_random_mating <- 40 # The number of generations to simulate during the random mating scenario of modern dog breeds
...
last_bottleneck_generation <- breed1_bottleneck[[n_generations]]
...
```{r}
random_mating_generations <- random_mating(last_bottleneck_generation, SP, n_generations_random_mating)
...
last_random_mating_generation


```
<!-- ## 2.4: Adding SNPs to the final bottleneck generation ( SimParam\$addSnpChip()) -->

<!-- ### 2.4.1 Single chromosome usage: Computing number of SNPs to assign to a chromosome -->
...
<!-- ### 2.4.2: SimParam\$addSnpChip() - Randomly assigns eligible SNPs to a SNP chip -->
...
<!-- **refPop**-argument specifies which population will be genotyped. In -->
<!-- this case, it will be the last_random_mating_generation after the simulated population -->
<!-- bottleneck scenario. -->
