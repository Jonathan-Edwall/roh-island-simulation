...
vertebrate_breed_ontology_ids <- Sys.getenv("vertebrate_breed_ontology_ids") # Identifying phenotypes labeled as either related to "Labrador retriever dog" or "unidentified breed"
