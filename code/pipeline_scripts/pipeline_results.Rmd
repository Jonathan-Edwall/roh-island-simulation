...
MAF_pruning_used <- Sys.getenv("MAF_pruning_used")

min_MAF_selection_testing <- Sys.getenv("min_MAF_selection_testing")
...
n_simulation_replicates <- as.numeric(Sys.getenv("n_simulation_replicates"))
...
Inbred_ancestral_population <- Sys.getenv("Inbred_ancestral_population")
...
n_individuals_breed_formation <- as.numeric(Sys.getenv("n_individuals_breed_formation"))

### Defining the Selection Model Simulation Settings ###
Simulate_Hard_Sweep <- Sys.getenv("Simulate_Hard_Sweep")
allele_copies_threshold <- Sys.getenv("allele_copies_threshold")
Variant_One_Individual_Origin <- Sys.getenv("Variant_One_Individual_Origin")
fixation_threshold_causative_variant <- Sys.getenv("fixation_threshold_causative_variant")
...
### OMIA phenotype data ###
omia_phenotypes_filepath <- Sys.getenv("omia_phenotypes_filepath")

omia_scraped_phenotypes_data_filepath <- Sys.getenv("omia_scraped_phenotypes_data_filepath") 

vertebrate_breed_ontology_ids <- Sys.getenv("vertebrate_breed_ontology_ids") # Identifying phenotypes labeled as either related to "Labrador retriever dog" or "unidentified breed" (if vertebrate_breed_ontology_ids="VBO_0200800,Unspecified")

### Gene Detection ###
Empirical_data_hotspot_gene_mapping_dir <- Sys.getenv("Empirical_data_hotspot_gene_mapping_dir")
gene_annotations_filepath <- Sys.getenv("gene_annotations_filepath")
############### 
## Simulated ###
###############
### Causative variant ###
...
The dashed horizontal red line represents the population $F_{ROH}$ for `r empirical_species`. The circle for each simulation type represents the point estimate $F_{ROH}$ across all 
