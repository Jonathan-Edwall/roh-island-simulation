# Dataset from Friedrich, Juliane et al. (2021). 
Article titled:

UK dogs data from: Genome-wide association studies for canine hip dysplasia in single and multiple populations – implications and potential novel risk lociU

## Usage notes (https://datadryad.org/stash/dataset/doi:10.5061/dryad.h44j0zpkf)
<b> Information about the dataset from the provided "README.txt" file:</b>
